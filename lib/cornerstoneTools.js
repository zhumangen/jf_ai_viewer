/*! cornerstone-tools - 1.1.2 - 2017-12-21 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
var _calculateEllipseStatistics = __webpack_require__(39);
...
function onImageRendered(e, eventData) {
  ...
  for (var i = 0; i < toolData.data.length; i++) {
    ...
    var leftCanvas = (handleStartCanvas.x, handleEndCanvas.x);
...
function onImageRendered(e, eventData, aiData) {
  ...
  for (var i = 0; i < toolData.data.length; i++) {
    ...
    var typeText = 'Type: ' + aiData.data.type;
